 ...
 */
UCLASS()
class AGILEGAME_API UAIMovementComponent : public UWheeledVehicleMovementComponent4W
{
	GENERATED_BODY()
	...
	UPROPERTY(EditAnywhere, Category = "PID")
		FPIDController SteeringControllerS = FPIDController(0, 0, 0, 0, 0);
...
public:
	virtual void RequestDirectMove(const FVector& MoveVecocity, bool bForceMaxSpeed) override;
